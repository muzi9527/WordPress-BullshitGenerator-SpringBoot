...
public class BullshitGenerator {
    static String random1;//论述
    static String random2;//名人名言
    static String random3;//后面垫话
    static String random4;//前面垫话
    static String random5;//初始主题
    static String bullshit;//合成中的狗屁
    static String super_bullshit;//最终狗屁

    public static void main(String[] args) {

    }

    public static String random(String title) throws InterruptedException {
        bullshit = "";
        super_bullshit = "";
//        //生成随机初始主题
//        for (int i = 0; i <= big_or_small(); i++) {
//            bullshit = getRandom5() + bullshit;
//            random5 = bullshit;
//        }
        //生成随机前面垫话
        for (int i = 0; i <= big_or_small(); i++) {
            bullshit = getRandom3() + bullshit;
            random3 = bullshit;
        }
        //生成随机后面垫话
        for (int i = 0; i <= big_or_small(); i++) {
            bullshit = getRandom4() + bullshit;
            random4 = bullshit;
        }
        //生成随机名人名言
        for (int i = 0; i <= big_or_small(); i++) {
            bullshit = getRandom1() + bullshit;
            //随机生成前面垫话放在名人名言前
            if (big_or_small() > 4) {
                random1 = random4 + bullshit;
                bullshit = random1;
            }
            //随机生成后面垫话放在名人名言后
            if (big_or_small() > 4) {
                random1 = bullshit + random3;
                bullshit = random1;
            }
            random1 = bullshit;
        }
        //生成随机论述
        for (int i = 0; i <= big_or_small(); i++) {
            bullshit = getRandom2() + bullshit;
            random2 = bullshit;
        }
        bullshit = title+","+random2 + random1;
        //替换title
        bullshit = bullshit.replaceAll("主题", title);
        //合成
        super_bullshit = bullshit;

        return super_bullshit;
    }

    public static String getRandom1() {
        random1 = "";
        String[] 论述 = {"现在，解决主题的问题，是非常非常重要的。 所以， ",
        ...
        int index1 = (int) (Math.random() * 论述.length);
        random1 = 论述[index1];
        return random1;
    }
    ...
    public static String getRandom2() {
        random2 = "";
        String[] 名人名言 = {"伏尔泰曾经说过，不经巨大的困难，不会有伟大的事业。这不禁令我深思",
        ...
        int index2 = (int) (Math.random() * 名人名言.length);
        random2 = 名人名言[index2];
        return random2;
    }
    ...
    public static String getRandom3() {
        ...
        String[] 后面垫话 = {"这不禁令我深思。 ",
                ...
                "这句话语虽然很短，但令我浮想联翩。 ",
                "这似乎解答了我的疑惑。 "};
        int index3 = (int) (Math.random() * 后面垫话.length);
        random3 = 后面垫话[index3];
        return random3;
    }
    ...
    public static String getRandom4() {
        ...
        String[] 前面垫话 = {"曾经说过",
                ...
                "曾经提到过",
                "说过一句富有哲理的话"};
        int index4 = (int) (Math.random() * 前面垫话.length);
        random4 = 前面垫话[index4];
        return random4;
    }
    ...
    public static String getRandom5() {
        random5 = "";
        String[] 初始主题 = {"一天掉多少根头发",
                "中午吃什么",
                "学生会退会",
                "好好学习",
                "生活的意义",
                "科学和人文谁更有意义"};
        int index5 = (int) (Math.random() * 初始主题.length);
        random5 = 初始主题[index5];
        return random5;
    }
    ...
    public static int big_or_small() {
        int max = 5, min = 1;
        int ran = (int) (Math.random() * (max - min) + min);
        return ran;
    }
